...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 28, 2018 at 04:05 PM
...
INSERT INTO `organization` (`orgName`, `password`, `school`) VALUES
('Admin', 'Admin', 'Admin'),
('BAGGS', 'BAGGS', NULL),
('BIBAK', 'BIBAK', NULL),
('CCPG', 'CCPG', NULL),
('DEBATESOCIETY', 'DEBATESOCIETY', NULL),
('ECOLODIANS', 'ECOLODIANS', NULL),
('FACULTY-SAMCIS', 'FACULTY-SAMCIS', 'SAMCIS'),
('FACULTY-SCIS', 'FACULTY-SCIS', 'SCIS'),
('FACULTY-SEA', 'FACULTY-SEA', 'SEA'),
('FACULTY-SNS', 'FACULTY-SNS', 'SNS'),
('FACULTY-SOL', 'FACULTY-SOL', 'SOL'),
('FACULTY-SOM', 'FACULTY-SOM', 'SOM'),
('FACULTY-SON', 'FACULTY-SON', 'SON'),
('FACULTY-STELA', 'FACULTY-STELA', 'STELA'),
('NURSCENE', 'NURSCENE', 'SON'),
('REDCROSS', 'REDCROSS', NULL),
('SCHEMA', 'SCHEMA', 'SAMCIS'),
('SLAS', 'SLAS', NULL),
('SSC-EXECOM', 'SSC-EXECOM', NULL),
('SSC-SAMCIS', 'SSC-SAMCIS', 'SAMCIS'),
('SSC-SEA', 'SSC-SEA', 'SEA'),
('SSC-SNS', 'SSC-SNS', 'SNS'),
('SSC-SOL', 'SSC-SOL', 'SOL'),
('SSC-SOM', 'SSC-SOM', 'SOM'),
('SSC-SON', 'SSC-SON', 'SON'),
('SSC-STELA', 'SSC-STELA', 'STELA'),
('STELLARIS', 'STELLARIS', 'STELA'),
('THEBUTTRESS', 'THE BUTTRESS', 'SEA'),
('TINIGHIMIG', 'TINIGHIMIG', NULL),
('VINCULUM', 'VINCULUM', NULL);
